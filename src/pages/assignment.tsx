          ...
          <CardContent>
            <section className='mb-8'>
              ...
              <ul className='list-disc pl-5 space-y-2'>
                ...
                <li>
                  Pay attention to performance and smoothness of the page.
                </li>
                <li>
        ...
        <Card className='mb-6'>
          ...
          <CardContent>
            <p className='text-lg mb-4'>
              The app is structured using React and divided into smaller,
              reusable components for better maintainability and scalability:
            </p>
            <ul className='list-disc pl-5 space-y-2'>
              <li>
                <strong>MovieItem:</strong> Renders the movie's image, title,
                and release date.
              </li>
              <li>
              ...
              <li>
                <strong>API Service:</strong> Encapsulates the logic for
